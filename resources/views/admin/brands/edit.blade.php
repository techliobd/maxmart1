<x-admin-layout>
    ...
    <x-slot name="subtitle">Update brand information</x-slot>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Brand description, story, or about information (optional)">{{ old('description', $brand->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50" id="logo-preview-container">
                        @if($brand->logo)
                            <img id="logo-preview" src="{{ asset('storage/' . $brand->logo) }}" alt="{{ $brand->name }}" class="w-full h-full object-contain rounded-lg p-2">
                            <div id="logo-placeholder" class="text-center hidden">
                    ...
                    <div>
                        ...
                        <label for="logo" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-200 cursor-pointer transition-colors">
                            ...
                            {{ $brand->logo ? 'Change Logo' : 'Choose Logo' }}
                        </label>
                        <input type="file" 
                               name="logo" 
                               id="logo" 
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500"><span id="meta-title-count">{{ strlen($brand->meta_title ?? '') }}</span>/60 characters</p>
                        @error('meta_title')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" 
                                  ...
                                  placeholder="SEO description (max 160 characters)">{{ old('meta_description', $brand->meta_description) }}</textarea>
                        <p class="mt-1 text-xs text-gray-500"><span id="meta-desc-count">{{ strlen($brand->meta_description ?? '') }}</span>/160 characters</p>
