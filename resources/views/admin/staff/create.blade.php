...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Create a new admin or staff user</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="+1 (555) 123-4567"
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Recommended: 200x200px, max 2MB</p>
                    @error('avatar')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
