<x-admin-layout>
    <x-slot name="title">Create Attribute</x-slot>
    <x-slot name="subtitle">Add a new product attribute</x-slot>
    ...
    <div class="space-y-6">
        <form action="{{ route('admin.attributes.store') }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <p class="text-sm text-gray-500 mb-4">Define the possible values for this attribute (e.g., Red, Blue, Green for Color)</p>
                    ...
                    <div class="flex items-center">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('is_visible_on_product', true) ? 'checked' : '' }}
                                   class="sr-only peer">
