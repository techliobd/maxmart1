            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-yellow-600">Cannot select itself or its own descendants as parent</p>
                        @error('parent_id')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500"><span id="meta-title-count">{{ strlen($category->meta_title ?? '') }}</span>/60 characters</p>
                        @error('meta_title')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" 
                                  ...
                                  placeholder="SEO description (max 160 characters)">{{ old('meta_description', $category->meta_description) }}</textarea>
                        <p class="mt-1 text-xs text-gray-500"><span id="meta-desc-count">{{ strlen($category->meta_description ?? '') }}</span>/160 characters</p>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50" id="image-preview-container">
                        @if($category->image)
                            <img id="image-preview" src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" class="w-full h-full object-cover rounded-lg">
