            ...
            <div class="max-w-md mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                    ...
                    <p class="mt-8 text-center text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="text-primary-600 hover:text-primary-700 font-medium">Sign up for free</a>
                    </p>
                </div>
                ...
                @if(Route::has('shop'))
                    <p class="mt-6 text-center text-sm text-gray-600">
                        Just browsing? 
                        <a href="{{ route('shop') }}" class="text-primary-600 hover:text-primary-700 font-medium">Continue shopping as guest</a>
                    </p>
                @endif
            </div>
        </div>
